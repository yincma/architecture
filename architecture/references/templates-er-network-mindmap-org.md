...
Entity-Relationship diagrams show database entities and their relationships. Use swimlane-style cells for entities with attribute lists, and labeled edges for relationships with cardinality.
  ...
  <diagram id="er-1" name="ER Diagram">
    <mxGraphModel dx="0" dy="0" grid="1" gridSize="10" guides="1"
      ...
      <root>
        ...
        <!-- Entity: User -->
        <mxCell id="entity-1" value="User" style="swimlane;fontStyle=1;align=center;startSize=26;html=1;fillColor=#DAE8FC;strokeColor=#6C8EBF;fontColor=#333333;fontSize=14;" vertex="1" parent="1">
          <mxGeometry x="80" y="160" width="200" height="140" as="geometry"/>
        </mxCell>
        <mxCell id="entity-1-attrs" value="PK  user_id: INT&#xa;     name: VARCHAR(100)&#xa;     email: VARCHAR(255)&#xa;     created_at: TIMESTAMP" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;whiteSpace=wrap;html=1;fontSize=12;" vertex="1" parent="entity-1">
          <mxGeometry y="26" width="200" height="114" as="geometry"/>
        </mxCell>
        <!-- Entity: Order -->
        <mxCell id="entity-2" value="Order" style="swimlane;fontStyle=1;align=center;startSize=26;html=1;fillColor=#D5E8D4;strokeColor=#82B366;fontColor=#333333;fontSize=14;" vertex="1" parent="1">
          <mxGeometry x="400" y="160" width="200" height="140" as="geometry"/>
        </mxCell>
        <mxCell id="entity-2-attrs" value="PK  order_id: INT&#xa;FK  user_id: INT&#xa;     total: DECIMAL(10,2)&#xa;     status: VARCHAR(20)" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;whiteSpace=wrap;html=1;fontSize=12;" vertex="1" parent="entity-2">
          <mxGeometry y="26" width="200" height="114" as="geometry"/>
        </mxCell>
        <!-- Entity: Product -->
        <mxCell id="entity-3" value="Product" style="swimlane;fontStyle=1;align=center;startSize=26;html=1;fillColor=#FFF2CC;strokeColor=#D6B656;fontColor=#333333;fontSize=14;" vertex="1" parent="1">
          <mxGeometry x="400" y="420" width="200" height="140" as="geometry"/>
        </mxCell>
        <mxCell id="entity-3-attrs" value="PK  product_id: INT&#xa;     name: VARCHAR(200)&#xa;     price: DECIMAL(10,2)&#xa;     stock: INT" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;whiteSpace=wrap;html=1;fontSize=12;" vertex="1" parent="entity-3">
          <mxGeometry y="26" width="200" height="114" as="geometry"/>
        </mxCell>
        <!-- Relationships -->
        <mxCell id="rel-1" value="" style="endArrow=ERmany;startArrow=ERone;endFill=0;startFill=0;html=1;strokeColor=#6C8EBF;fontSize=12;" edge="1" source="entity-1" target="entity-2" parent="1">
          <mxGeometry relative="1" as="geometry"/>
        </mxCell>
        <mxCell id="rel-1-label" value="places&#xa;1:N" style="edgeLabel;html=1;align=center;verticalAlign=middle;resizable=0;points=[];fontSize=12;fontColor=#333333;" vertex="1" connectable="0" parent="rel-1">
          <mxGeometry x="-0.1" relative="1" as="geometry">
            <mxPoint as="offset"/>
          </mxGeometry>
        </mxCell>
        <mxCell id="rel-2" value="" style="endArrow=ERmany;startArrow=ERmany;endFill=0;startFill=0;html=1;strokeColor=#82B366;fontSize=12;" edge="1" source="entity-2" target="entity-3" parent="1">
          <mxGeometry relative="1" as="geometry"/>
        </mxCell>
        <mxCell id="rel-2-label" value="contains&#xa;M:N" style="edgeLabel;html=1;align=center;verticalAlign=middle;resizable=0;points=[];fontSize=12;fontColor=#333333;" vertex="1" connectable="0" parent="rel-2">
          <mxGeometry x="-0.1" relative="1" as="geometry">
            <mxPoint as="offset"/>
          </mxGeometry>
        </mxCell>
...
| Key Point | Detail |
|-----------|--------|
| Entity box | `swimlane;fontStyle=1;startSize=26;` (same as UML class) |
| Attributes | `text;` cell parented to entity, list PK/FK prefixes |
| 1:N relationship | `startArrow=ERone;endArrow=ERmany;` |
| M:N relationship | `startArrow=ERmany;endArrow=ERmany;` |
| 1:1 relationship | `startArrow=ERone;endArrow=ERone;` |
| Edge label | `edgeLabel;` cell with `connectable=0; parent=rel-N` |
  ...
  <diagram id="mindmap-1" name="Mind Map">
    <mxGraphModel dx="0" dy="0" grid="1" gridSize="10" guides="1"
      ...
      <root>
        ...
        <!-- Edges: branches to sub-branches -->
  ...
  <diagram id="orgchart-1" name="Organization Chart">
    <mxGraphModel dx="0" dy="0" grid="1" gridSize="10" guides="1"
      ...
      <root>
        ...
        <!-- Reporting lines: VPs to Team Members -->
